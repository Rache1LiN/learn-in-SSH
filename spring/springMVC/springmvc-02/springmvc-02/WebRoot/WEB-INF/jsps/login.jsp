    ...
    <input type="hidden" name="oper" value="loginDeal"/>
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="userName" name="userName" value="${userName }" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="validateCode" class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="" style="width:150px;">
          <img src="validate" id="validateCode"> <a id="kanbuq" href="javascript:changeValidateCode();">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<script>
	...
	function changeValidateCode(){
		...
		$("#validateCode").attr("src","validate?d=" + timenow);
	}
	$(function(){
		changeValidateCode();
	});
