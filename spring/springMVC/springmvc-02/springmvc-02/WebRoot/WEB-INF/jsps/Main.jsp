				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加资讯','${pageContext.request.contextPath }/NewsCat?oper=insert')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="#">切换账户</a></li>
						<li><a href="${pageContext.request.contextPath }/login?oper=logoutDeal">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="NewsCat?oper=list" data-title="资讯列表" href="javascript:void(0)">资讯列表</a></li>
			...
			<dd>
				...
				<!-- <li><a data-href="member-list.html" data-title="会员列表" href="javascript:;">会员列表</a></li>
				 ...
				 -->
					...
					<li><a data-href="Member?oper=list" data-title="会员列表" href="javascript:void(0);">会员列表</a></li>
				</ul>
		</dd>
	</dl>
		<dl id="menu-admin">
